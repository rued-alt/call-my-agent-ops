...
- Name: master/surface/costs.master.spec.ts >> Costs (/costs) >> clicking a cost row opens the breakdown drawer with provider×model drill-down
- Location: tests/e2e/master/surface/costs.master.spec.ts:27:3
