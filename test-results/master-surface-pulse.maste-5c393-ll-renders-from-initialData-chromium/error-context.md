...
- Name: master/surface/pulse.master.spec.ts >> Pulse (/pulse) >> error-state: 500 on every endpoint still renders from initialData
- Location: tests/e2e/master/surface/pulse.master.spec.ts:45:3
