...
- Name: master/surface/customers.master.spec.ts >> Customers (/customers) >> empty-state: when customers endpoint returns [], surface still renders (falls back)
- Location: tests/e2e/master/surface/customers.master.spec.ts:36:3
