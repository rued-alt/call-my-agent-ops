...
- Name: master/surface/pulse.master.spec.ts >> Pulse (/pulse) >> dismissing an alert removes it from the list
- Location: tests/e2e/master/surface/pulse.master.spec.ts:24:3
