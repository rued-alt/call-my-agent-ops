...
- Name: master/surface/pulse.master.spec.ts >> Pulse (/pulse) >> empty-state: when alerts endpoint returns [], shows "Nothing on fire"
- Location: tests/e2e/master/surface/pulse.master.spec.ts:36:3
