...
- Name: master/surface/customers.master.spec.ts >> Customers (/customers) >> renders buckets + table with no console errors
- Location: tests/e2e/master/surface/customers.master.spec.ts:7:3
