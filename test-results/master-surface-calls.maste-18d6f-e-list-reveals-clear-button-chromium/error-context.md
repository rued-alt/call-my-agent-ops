...
- Name: master/surface/calls.master.spec.ts >> Calls (/calls) >> toggling a filter chip filters the list + reveals clear button
- Location: tests/e2e/master/surface/calls.master.spec.ts:19:3
