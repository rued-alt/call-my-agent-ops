...
- Name: master/surface/keyboard-shortcuts.master.spec.ts >> Keyboard shortcuts (global) >> chrome tab Links are keyboard-focusable (tab navigation works)
- Location: tests/e2e/master/surface/keyboard-shortcuts.master.spec.ts:15:3
