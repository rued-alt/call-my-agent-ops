...
- Name: master/surface/mission.master.spec.ts >> Mission Control (/mission) >> event stream renders stream lines (or stays empty)
- Location: tests/e2e/master/surface/mission.master.spec.ts:31:3
