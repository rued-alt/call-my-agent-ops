...
- Name: master/surface/customers.master.spec.ts >> Customers (/customers) >> error-state: 500 falls back to fixture (initialData)
- Location: tests/e2e/master/surface/customers.master.spec.ts:45:3
