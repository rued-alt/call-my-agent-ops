...
- Name: master/surface/role-gating.master.spec.ts >> Role gating >> readonlyPage can VIEW every surface (role-badge: Read-only)
- Location: tests/e2e/master/surface/role-gating.master.spec.ts:44:3
