...
- Name: master/surface/pulse.master.spec.ts >> Pulse (/pulse) >> renders heading + tiles + sparks + alerts with no console errors
- Location: tests/e2e/master/surface/pulse.master.spec.ts:7:3
