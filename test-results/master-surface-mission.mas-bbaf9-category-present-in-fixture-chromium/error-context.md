...
- Name: master/surface/mission.master.spec.ts >> Mission Control (/mission) >> agent stack renders one row per category present in fixture
- Location: tests/e2e/master/surface/mission.master.spec.ts:24:3
