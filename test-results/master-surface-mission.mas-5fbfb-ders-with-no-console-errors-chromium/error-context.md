...
- Name: master/surface/mission.master.spec.ts >> Mission Control (/mission) >> renders with no console errors
- Location: tests/e2e/master/surface/mission.master.spec.ts:7:3
