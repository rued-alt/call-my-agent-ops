...
- Name: master/surface/audit-drawer.master.spec.ts >> Audit drawer >> Audit button is visible and opens the drawer
- Location: tests/e2e/master/surface/audit-drawer.master.spec.ts:15:3
...
Locator: locator('[data-region="ops-chrome-audit-button"]')
Expected: visible
Timeout: 5000ms
