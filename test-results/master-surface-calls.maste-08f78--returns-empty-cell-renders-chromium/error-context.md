...
- Name: master/surface/calls.master.spec.ts >> Calls (/calls) >> empty-state: when calls endpoint returns [], empty cell renders
- Location: tests/e2e/master/surface/calls.master.spec.ts:46:3
