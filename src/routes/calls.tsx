  ...
  return (
    <div style={{ minHeight: '100vh', background: t.color.background }}>
      ...
      <main style={{ padding: `${t.space.unit * 8}px ${t.space.unit * 5}px`, fontFamily: t.type.bodyFamily, color: t.color.foreground }}>
        <h1 style={{ fontFamily: t.type.headingFamily, fontSize: 28, fontWeight: t.type.headingWeight }}>Calls</h1>
        <p style={{ color: t.color.muted, marginTop: t.space.unit * 2 }}>Calls coming soon — call list, transcript view, PII-reveal flow.</p>
      </main>
    </div>
  )
}
